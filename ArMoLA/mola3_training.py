...
from transformers import LlamaTokenizer, AutoConfig, AutoTokenizer
from src.mola_modeling_llama3_hacked import LlamaForCausalLM_d
...
def train(
    ...
    if resume_from_checkpoint:
        ...
        if os.path.exists(checkpoint_name):
            ...
            set_peft_model_state_dict_moe(model, adapters_weights, train_mode=True)
        else:
