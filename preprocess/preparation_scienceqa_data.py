...
if __name__ == "__main__":
    ...
    dataset_path = '/root/moe/datasets/datas/commonsense_qa/data'
    print((f'{dataset_path}/train*.parquet'))
    datasets_scienceqa = load_dataset('parquet', data_files={
        'train': glob.glob(f'{dataset_path}/train*.parquet'),
        'validation': glob.glob(f'{dataset_path}/validation*.parquet'),
        'test': glob.glob(f'{dataset_path}/test*.parquet'),
    })
    print(datasets_scienceqa['train'][:5])
